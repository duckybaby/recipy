...
- "imageUrl" in the source object: ALWAYS emit null. The server extracts the og:image directly from the source page HTML and overwrites whatever you put here — your imageUrl is ignored either way. Do not attempt to find, guess, or fabricate an image URL; it wastes tokens for no effect. Just emit null.
